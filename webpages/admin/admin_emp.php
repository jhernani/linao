...
<div class="ui vertical inverted sidebar menu">
  ...
  <div class="ui inverted vertical center aligned segment">
    ...
    <div class="ui container">
      <div class="ui large secondary inverted pointing menu">
        ...
        <a class="item" href="admin_sales.php">Sales</a>
        <a class="item" href="admin_inventory.php">Inventory</a>
        <a class="active item" >Employee</a>
        <a class="item" href="admin_branch.php">Branches</a>
  ...
  <div class="ui container">
    ...
    <div>
      <center>
        <a href="add_emp.php"><button class="ui green huge submit button">
          <i class="open folder icon"></i>
          Add New Employee
        </button></a>
        <a href="view_emp_archive.php"><button class="ui red huge submit button">
          <i class="open folder icon"></i>
    ...
    <center><table class="ui green selectable table">
      ...
      <tbody>
              ...
              <?php
                  ...
                  $sql = 'SELECT * FROM employee WHERE status != "INACTIVE" ORDER BY branch_id AND employee_name';
                  foreach ($pdo->query($sql) as $row) {
                        ...
                        echo '<td>';
                        echo '<a href="update_emp.php?id='.$row['employee_id'].'"><button class="ui small orange button"><i class="archive icon"></i>Update</button></a>';
                        echo '</td>';
                        echo '<td>';
                        echo '<a href="archive_emp.php?id='.$row['employee_id'].'"><button class="ui small negative button"><i class="archive icon"></i>Archive</button></a>';
                        echo '</td>';
                        echo '</tr>';
                  }
                  Database::disconnect();
